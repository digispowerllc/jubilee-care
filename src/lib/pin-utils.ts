...
import { verifyHash, protectData, unprotectData, generateSearchableHash } from '@/lib/security/dataProtection';

export async function verifyAgentPin(agentId: string, pin: string): Promise<boolean> {
