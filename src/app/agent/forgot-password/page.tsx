...
import AgentForgotPasswordSeo from "@/components/seo/AgentForgotPasswordSeo";
        ...
        >
          ...
          <div className="text-center">
            <motion.div
              initial={{ scale: 0 }}
              animate={{ scale: 1 }}
              className="inline-flex items-center justify-center w-16 h-16 bg-gradient-to-r from-green-500 to-green-600 rounded-2xl mb-4 mx-auto"
            >
                  ...
                  <div className="flex items-center justify-center">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-green-700">
                        If your email is associated with an account, we&#39;ve
