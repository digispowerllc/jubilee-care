  ...
  return (
    <div className="w-full max-w-md p-8 space-y-6 bg-white rounded-xl shadow-lg">
      <div className="text-center">
        <h1 className="text-3xl mb-10 font-bold text-gray-900">Agent Portal</h1>
        ...
        <div className="relative">
          ...
          <div className="relative flex justify-center text-sm mb-7 mt-7">
      ...
      {activeTab === "standard" ? (
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div>
            ...
            <input
              ...
              placeholder="Enter your e-Mail address or phone"
              disabled={loading}
            />
          </div>
        ...
        <form onSubmit={handleNimcSubmit} className="space-y-5">
          {/* NIMC Verification Form */}
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-1">
