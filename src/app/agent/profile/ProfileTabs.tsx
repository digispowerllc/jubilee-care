...
import { FiUser, FiLock, FiMail, FiMapPin, FiShield, FiActivity, FiEdit2, FiEye, FiEyeOff } from "react-icons/fi";
        ...
        <TabPanel className="bg-white rounded-xl p-4 md:p-6 shadow-sm">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
            <div className="space-y-4 md:space-y-6">
              <div>
                <h3 className="text-lg font-semibold mb-3 md:mb-4">Account Summary</h3>
              ...
              <div>
                ...
                <div className="space-y-2 md:space-y-3">
                  <div className="flex items-start gap-2 md:gap-3">
                    ...
                    <div>
                      <p className="text-xs md:text-sm font-medium">Profile updated</p>
            ...
            <div>
              <h3 className="text-lg font-semibold mb-3 md:mb-4">Security Status</h3>
                ...
                <div className="space-y-3">
                  <div className="flex items-center justify-between">
                    ...
                    {unprotectedData.emailVerified ? (
                      ...
                      <button className="text-primary text-sm font-medium">Verify Now</button>
                    )}
                  </div>
                  <div className="flex items-center justify-between">
            ...
            <div className="space-y-3 md:space-y-4">
              <div>
                ...
                <div className="p-2 md:p-3 bg-gray-50 rounded-lg border border-gray-200 flex justify-between items-center">
                  ...
                  >
                    {pinVerified && showNIN ? <FiEyeOff size={16} /> : <FiEye size={16} />}
                  </button>
                </div>
              </div>
              <div>
              ...
              <div>
                ...
                <div className="p-2 md:p-3 bg-gray-50 rounded-lg border border-gray-200 flex justify-between items-center">
                  ...
                  <button 
                    onClick={() => {
                      if (!pinVerified) {
                        const enteredPin = prompt("Enter your PIN to view phone number");
                        if (enteredPin) {
                          verifyPIN();
                          setShowPhone(true);
                        }
                    ...
                    className="text-primary hover:text-primary-dark"
                  >
                    {pinVerified && showPhone ? <FiEyeOff size={16} /> : <FiEye size={16} />}
                  </button>
                </div>
              </div>
            </div>
            ...
            <div className="p-3 md:p-4 border border-gray-200 rounded-lg">
              ...
              {isEditingPIN ? (
                <form onSubmit={handlePINUpdate} className="mt-3 space-y-3">
                  {pinVerified && (
                    <div>
                      <label className="block text-xs md:text-sm font-medium text-gray-700 mb-1">Current PIN</label>
                      <input
                        type="password"
                        inputMode="numeric"
                        pattern="[0-9]*"
                  ...
                  <div>
                    <label className="block text-xs md:text-sm font-medium text-gray-700 mb-1">New PIN</label>
                    <input
                      type="password"
                      inputMode="numeric"
                      pattern="[0-9]*"
                  ...
                  <div>
                    <label className="block text-xs md:text-sm font-medium text-gray-700 mb-1">Confirm PIN</label>
                    <input
                      type="password"
                      inputMode="numeric"
                      pattern="[0-9]*"
            ...
            <div className="p-3 md:p-4 border border-gray-200 rounded-lg">
              <div className="flex justify-between items-center">
                <div>
                  ...
                  <p className="text-xs md:text-sm text-gray-600">
                    {is2FAEnabled ? "Enabled" : "Disabled"} - Add an extra layer of security
                  </p>
                </div>
                <button
