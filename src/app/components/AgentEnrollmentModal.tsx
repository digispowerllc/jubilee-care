...
const AgentEnrollmentModal: React.FC<Props> = ({ onClose }) => {
  ...
  if (timeLeft.expired) return null; // Don't render anything if expired
  ...
  return (
    <div className="fixed inset-0 z-50 bg-black bg-opacity-50 flex items-center justify-center">
      <div className="bg-white rounded-lg p-6 shadow-xl max-w-lg w-full relative">
        ...
        <h2 className="text-xl font-bold text-green-700 mb-2">Agent Enrollment In Progress</h2>
        <p className="text-gray-700 mb-2">
          Our agent onboarding window is currently open. You may begin your registration online or visit any
          accredited enrollment centre for assisted signup.
        </p>

        <div className="text-sm text-yellow-700 bg-yellow-50 p-2 rounded mb-4">
          ⏳ This enrollment link will close by <strong>3:00 PM</strong> today. Time left:{" "}
