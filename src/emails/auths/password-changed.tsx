...
export const PasswordChangedEmail = ({ 
  ...
  supportEmail = 'support@ourservice.com',
  ipAddress = 'Unknown',
  ...
  <Html>
    ...
    <Body style={main}>
      <Container style={container}>
        ...
        <Button style={button} href={`https://${companyName.toLowerCase()}.com/account/security`}>
          Secure Your Account Now
        </Button>

        <Text style={paragraph}>
          Contact our <Link style={link} href={`mailto:${supportEmail}`}>
            support team
          </Link> immediately if you suspect unauthorized access.
        </Text>
