// file: src/emails/login-notification.tsx
    ...
    <Body style={main}>
      <Container style={container}>
        ...
        <Text style={paragraph}>
          We detected a new login to your {companyName} account on <strong>{loginTime}</strong>.
        </Text>
        ...
        <Text style={paragraph}>
          For your security, we recommend changing your password immediately if you didn&#39;t authorize this login.
        </Text>

        <Text style={paragraph}>
          Need help? Contact our <Link style={link} href={supportLink}>
            support team
          </Link>.
        </Text>
